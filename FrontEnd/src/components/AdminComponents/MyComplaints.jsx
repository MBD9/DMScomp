...
function MyComplaints() {
    ...
    async function getdata() {
        ...
        try {
            const res = await axios.post("http://localhost:8000/dealer/MyComplints", {
                UserName: storedDealer.UserName,
            });
                            ...
                            >
                                ...
                                <td className="px-6 py-4 hover:text-white">
                                    <button
                                        ...
                                        type="button"
                                        className={`text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 ${complaint.state === "Completed" ? "opacity-50 cursor-not-allowed" : ""
                                            }`}
                                        disabled={complaint.state === "Pending"}
                                    >
                                        ReOpen
                                    </button>
                                </td>
